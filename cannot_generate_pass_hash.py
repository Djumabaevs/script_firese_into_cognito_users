...
def lambda_handler(event, context):
    ...
    for firebase_user in firebase_users.users:
        try:
            ...
            password_hash = requests.get(f"https://identitytoolkit.googleapis.com/v1/projects/memr-e997e/accounts:lookup?key=AIzaSyAEeoTNm33eNkJkjfEQtVP_Z2zNdunQrFw", params={
                                         "email": firebase_user.email}).json()["users"][0]["passwordHash"]
            print(passwordHash)
            print(uid)
